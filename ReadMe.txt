...
2) You run the program 'InkShim.py' with appropriate arguments. Running it without arguments or with --help should give you the information that you need. Try "InkShim.py '(1,1):(1,0)'"
